...
var videoInputRatioMap = map[string]float64{
	...
	"doubao-seedance-2.0-face":        28.0 / 46.0,
	"doubao-seedance-2.0-fast":        22.0 / 37.0,
	"doubao-seedance-2.0-fast-face":   22.0 / 37.0,
	"seed-2":                          28.0 / 46.0, // inferred alias of doubao-seedance-2-0-260128
	"seed-2-vision":                   28.0 / 46.0, // inferred alias of doubao-seedance-2-0-260128
	"seed-2-fast":                     22.0 / 37.0, // inferred alias of doubao-seedance-2-0-fast-260128
	"seed-2-fast-vision":              22.0 / 37.0, // inferred alias of doubao-seedance-2-0-fast-260128
}
