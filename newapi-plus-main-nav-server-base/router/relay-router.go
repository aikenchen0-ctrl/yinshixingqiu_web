...
func SetRelayRouter(router *gin.Engine) {
	...
	duomiSunoRouter := router.Group("/api/suno")
	duomiSunoRouter.Use(middleware.RouteTag("relay"))
	duomiSunoRouter.Use(middleware.SystemPerformanceCheck())
	duomiSunoRouter.Use(middleware.TokenAuth())
	{
		duomiSunoRouter.POST("/generate", controller.DuomiSunoGenerate)
		duomiSunoRouter.GET("/feed", controller.DuomiSunoFeed)
	}
