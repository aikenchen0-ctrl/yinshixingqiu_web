...
type User struct {
	...
	AgentRebateBalance       float64        `json:"agent_rebate_balance" gorm:"type:decimal(12,6);size:12;not null;default:0.000000"`
	AgentRebateHistoryAmount float64        `json:"agent_rebate_history_amount" gorm:"type:decimal(12,6);size:12;not null;default:0.000000"`
...
func (user *User) Edit(updatePassword bool) error {
	...
	updates := map[string]interface{}{
		...
		"agent_rebate_rate_bps": newUser.AgentRebateRateBps,
	}
	if updatePassword {
